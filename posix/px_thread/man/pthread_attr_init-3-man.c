...
EXAMPLE
   ...
   Program source
       ...
       display_pthread_attr(pthread_attr_t *attr, char *prefix)
       {
           ...
           if (s != 0)
               show_error_en(s, "pthread_attr_getdetachstate");
           ...
           if (s != 0)
               show_error_en(s, "pthread_attr_getscope");
           printf("%sScope               = %s\n", prefix,
           ...
           if (s != 0)
               show_error_en(s, "pthread_attr_getinheritsched");
           ...
           if (s != 0)
               show_error_en(s, "pthread_attr_getschedpolicy");
           ...
           if (s != 0)
               show_error_en(s, "pthread_attr_getschedparam");
           printf("%sScheduling priority = %d\n", prefix, sp.sched_priority);

           s = pthread_attr_getguardsize(attr, &v);
           if (s != 0)
               show_error_en(s, "pthread_attr_getguardsize");
           printf("%sGuard size          = %d bytes\n", prefix, v);

           s = pthread_attr_getstack(attr, &stkaddr, &v);
           if (s != 0)
               show_error_en(s, "pthread_attr_getstack");
       ...
       thread_start(void *arg)
       {
           ...
           if (s != 0)
               show_error_en(s, "pthread_getattr_np");
       ...
       main(int argc, char *argv[])
       {
           ...
           if (argc > 1) {
               ...
               if (s != 0)
                   show_error_en(s, "pthread_attr_setdetachstate");

               s = pthread_attr_setinheritsched(&attr, PTHREAD_EXPLICIT_SCHED);
               if (s != 0)
                   show_error_en(s, "pthread_attr_setinheritsched");

               stack_size = strtoul(argv[1], NULL, 0);

               s = posix_memalign(&sp, sysconf(_SC_PAGESIZE), stack_size);
               if (s != 0)
                   show_error_en(s, "posix_memalign");

               printf("posix_memalign() allocated at %p\n", sp);

               s = pthread_attr_setstack(&attr, sp, stack_size);
               if (s != 0)
                   show_error_en(s, "pthread_attr_setstack");
           }
