...
# 5 "/usr/local/include/lzl/misc.h" 2 3
...
long get_tsd(struct timespec *pt2,struct timespec *pt1,char lev){
 ...
 ({ tv->tv_nsec=pt2->tv_nsec-pt1->tv_nsec; if(tv->tv_nsec<0){ pt2->tv_sec--; tv->tv_nsec=1000000000-pt1->tv_nsec+pt2->tv_nsec; } tv->tv_sec=pt2->tv_sec-pt1->tv_sec; tv;});
 switch(lev){
 case 0:
...
# 9 "/usr/local/include/lzl/px_thread.h" 2 3
# 1 "/usr/include/errno.h" 1 3 4
...
# 1 "/usr/local/include/lzl/misc.h" 1 3
# 14 "/usr/local/include/lzl/px_thread.h" 2 3
# 72 "/usr/local/include/lzl/px_thread.h" 3
...
# 12 "/usr/local/include/lzl/px_shm.h" 2 3
...
# 5 "/usr/local/include/lzl/un_fifo.h" 2 3
...
int main(int argc,char *argv[]){
 log_init("l=11111");
 struct timespec ts1={0,200000000};
 struct timespec ts2={1,100000000};
 do{
  struct timespec tsv={0};
  long tsd=0;
  ({ &tsv->tv_nsec=pt2->tv_nsec-&ts1->tv_nsec; if(&tsv->tv_nsec<0){ pt2->tv_sec--; &tsv->tv_nsec=1000000000-&ts1->tv_nsec+pt2->tv_nsec; } &tsv->tv_sec=pt2->tv_sec-&ts1->tv_sec; &tsv;});

  
# 18 "px_timer_tls.c" 3
 slog(_INF,1,log_ctrl_set,out_path_set,"","px_timer_tls.c",18,
# 18 "px_timer_tls.c"
 "tsv=%3d.%09d",tsv.tv_sec,tsv.tv_nsec
# 18 "px_timer_tls.c" 3
 );;
# 18 "px_timer_tls.c"
                                           ;
...
# 19 "px_timer_tls.c" 3
 slog(_INF,1,log_ctrl_set,out_path_set,"","px_timer_tls.c",19,
# 19 "px_timer_tls.c"
 "tsd=%3d",tsd
# 19 "px_timer_tls.c" 3
 );;
