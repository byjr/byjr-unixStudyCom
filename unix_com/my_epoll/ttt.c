...
# 4 "my_epoll_srv.c" 2
# 1 "/usr/local/include/lzl/my_socket.h" 1 3
...
# 6 "/usr/local/include/lzl/my_socket.h" 2 3
# 1 "/usr/local/include/lzl/slog.h" 1 3
# 9 "/usr/local/include/lzl/slog.h" 3
...
# 7 "/usr/local/include/lzl/my_socket.h" 2 3
...
# 1 "/usr/local/include/slog.h" 1 3
# 6 "/usr/local/include/lzl/misc.h" 2 3
# 50 "/usr/local/include/lzl/misc.h" 3
typedef struct mimy_cmd_t{
 char *cmd;
 int (*handle)(void *);
}mimy_cmd_t;
...
# 8 "/usr/local/include/lzl/my_socket.h" 2 3
# 178 "/usr/local/include/lzl/my_socket.h" 3
int un_bind(int sfd,char *path);
int my_connect(int sfd,char *path);
int in_bind(int sfd,short port,char *ip);
int in_connect(int sfd,short port,char *ip);
# 5 "my_epoll_srv.c" 2
# 1 "/usr/local/include/lzl/my_fop.h" 1 3
...
# 5 "/usr/local/include/lzl/my_fop.h" 2 3
...
# 424 "/usr/include/x86_64-linux-gnu/bits/fcntl-linux.h" 3 4
...
# 6 "/usr/local/include/lzl/my_fop.h" 2 3
# 103 "/usr/local/include/lzl/my_fop.h" 3
...
int main(int argc,char *argv[]){
 ...
 log_init(
# 17 "my_epoll_srv.c" 3 4
         ((void *)0)
# 17 "my_epoll_srv.c"
             );
 ls_fd=
# 18 "my_epoll_srv.c" 3
      ({ int ret=socket(1, SOCK_STREAM, 
# 18 "my_epoll_srv.c"
      0
# 18 "my_epoll_srv.c" 3
      ); if(-1==ret)do { if(0){ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",18,"%s failure,errno=%d[%s]","socket",0,strerror(0));;; }else{ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",18,"%s failure,errno=%d[%s]","socket",(*__errno_location ()),strerror((*__errno_location ())));;; } }while(0); ret;})
# 18 "my_epoll_srv.c"
                                      ;
 if(-1==ls_fd)return -1;
 ret=un_bind(ls_fd,"/tmp/sock_path.unix");
 if(-1==ret)return -1;
 ret=
# 22 "my_epoll_srv.c" 3
    ({ int ret=listen(
...
# 22 "my_epoll_srv.c"
    5
# 22 "my_epoll_srv.c" 3
    ); if(-1==ret)do { if(0){ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",22,"%s failure,errno=%d[%s]","listen",0,strerror(0));;; }else{ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",22,"%s failure,errno=%d[%s]","listen",(*__errno_location ()),strerror((*__errno_location ())));;; } }while(0); ret;})
# 22 "my_epoll_srv.c"
                      ;
 if(-1==ret)return -1;
 epfd=({ int epfd=epoll_create1(0); if(-1==epfd)
# 24 "my_epoll_srv.c" 3
     do { if(
# 24 "my_epoll_srv.c"
     0
# 24 "my_epoll_srv.c" 3
     ){ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",24,"%s failure,errno=%d[%s]",
# 24 "my_epoll_srv.c"
     "epoll_create1"
# 24 "my_epoll_srv.c" 3
     ,
...
# 24 "my_epoll_srv.c"
     0
# 24 "my_epoll_srv.c" 3
     ));;; }else{ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",24,"%s failure,errno=%d[%s]",
# 24 "my_epoll_srv.c"
     "epoll_create1"
# 24 "my_epoll_srv.c" 3
...
# 24 "my_epoll_srv.c"
     ; epfd;});
 if(epfd<0)return -1;
 ({ struct epoll_event ev; ev.events = 
# 26 "my_epoll_srv.c" 3 4
EPOLLIN
# 26 "my_epoll_srv.c"
; ev.data.fd = ls_fd; int ret=epoll_ctl(epfd,
# 26 "my_epoll_srv.c" 3 4
1
# 26 "my_epoll_srv.c"
,ls_fd,&ev); if(-1==ret)
...
0
# 26 "my_epoll_srv.c" 3
){ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",26,"%s failure,errno=%d[%s]",
# 26 "my_epoll_srv.c"
"epoll_ctl"
# 26 "my_epoll_srv.c" 3
,
...
0
# 26 "my_epoll_srv.c" 3
));;; }else{ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",26,"%s failure,errno=%d[%s]",
# 26 "my_epoll_srv.c"
"epoll_ctl"
# 26 "my_epoll_srv.c" 3
,(*__errno_location ()),strerror((*__errno_location ())));;; } }while(0)
...
; ret;});
 ({ struct epoll_event ev; ev.events = 
# 27 "my_epoll_srv.c" 3 4
EPOLLIN
# 27 "my_epoll_srv.c"
; ev.data.fd = 0; int ret=epoll_ctl(epfd,
# 27 "my_epoll_srv.c" 3 4
1
# 27 "my_epoll_srv.c"
,0,&ev); if(-1==ret)
...
0
# 27 "my_epoll_srv.c" 3
){ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",27,"%s failure,errno=%d[%s]",
# 27 "my_epoll_srv.c"
"epoll_ctl"
# 27 "my_epoll_srv.c" 3
,
...
0
# 27 "my_epoll_srv.c" 3
));;; }else{ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",27,"%s failure,errno=%d[%s]",
# 27 "my_epoll_srv.c"
"epoll_ctl"
# 27 "my_epoll_srv.c" 3
,(*__errno_location ()),strerror((*__errno_location ())));;; } }while(0)
...
; ret;});
 do{
  n_ready=({ int n_ready=0; if(
# 29 "my_epoll_srv.c" 3 4
         ((void *)0)
# 29 "my_epoll_srv.c"
         ){ n_ready=epoll_pwait(epfd,events,10,-1,
# 29 "my_epoll_srv.c" 3 4
         ((void *)0)
# 29 "my_epoll_srv.c"
         ); }else{ n_ready=epoll_wait(epfd,events,10,-1); } if(-1==n_ready)
# 29 "my_epoll_srv.c" 3
         do { if(
# 29 "my_epoll_srv.c"
         0
# 29 "my_epoll_srv.c" 3
         ){ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",29,"%s failure,errno=%d[%s]",
# 29 "my_epoll_srv.c"
         "epoll_wait"
# 29 "my_epoll_srv.c" 3
         ,
...
# 29 "my_epoll_srv.c"
         0
# 29 "my_epoll_srv.c" 3
         ));;; }else{ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",29,"%s failure,errno=%d[%s]",
# 29 "my_epoll_srv.c"
         "epoll_wait"
# 29 "my_epoll_srv.c" 3
         ,(*__errno_location ()),strerror((*__errno_location ())));;; } }while(0)
...
# 38 "my_epoll_srv.c"
             &peerlen
# 38 "my_epoll_srv.c" 3
             ); if(-1==ret)do { if(0){ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",38,"%s failure,errno=%d[%s]","accept",0,strerror(0));;; }else{ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",38,"%s failure,errno=%d[%s]","accept",(*__errno_location ()),strerror((*__errno_location ())));;; } }while(0); ret;})
# 38 "my_epoll_srv.c"
                                                ;
     if(conn){
      ({ struct epoll_event ev; ev.events = 
# 40 "my_epoll_srv.c" 3 4
     EPOLLIN
# 40 "my_epoll_srv.c"
     ; ev.data.fd = conn; int ret=epoll_ctl(epfd,
# 40 "my_epoll_srv.c" 3 4
     1
# 40 "my_epoll_srv.c"
     ,conn,&ev); if(-1==ret)
...
# 40 "my_epoll_srv.c"
     0
# 40 "my_epoll_srv.c" 3
     ){ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",40,"%s failure,errno=%d[%s]",
# 40 "my_epoll_srv.c"
     "epoll_ctl"
# 40 "my_epoll_srv.c" 3
     ,
...
# 40 "my_epoll_srv.c"
     0
# 40 "my_epoll_srv.c" 3
     ));;; }else{ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",40,"%s failure,errno=%d[%s]",
# 40 "my_epoll_srv.c"
     "epoll_ctl"
# 40 "my_epoll_srv.c" 3
     ,(*__errno_location ()),strerror((*__errno_location ())));;; } }while(0)
...
# 45 "my_epoll_srv.c"
            sizeof(buf)
# 45 "my_epoll_srv.c" 3
            ); if(-1==ret_size){ do { if(0){ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",45,"%s failure,errno=%d[%s]","read",0,strerror(0));;; }else{ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",45,"%s failure,errno=%d[%s]","read",(*__errno_location ()),strerror((*__errno_location ())));;; } }while(0); } ret_size;})
# 45 "my_epoll_srv.c"
                                       ;
    if(0==n){
     
# 47 "my_epoll_srv.c" 3
    slog(_INF,log_ctrl_set,out_path_set,"","my_epoll_srv.c",47,
# 47 "my_epoll_srv.c"
    "peer close fd:%d",fd
# 47 "my_epoll_srv.c" 3
    );;
# 47 "my_epoll_srv.c"
                              ;
     ({ struct epoll_event ev; ev.events = events[i].events; ev.data.fd = fd; int ret=epoll_ctl(epfd,
# 48 "my_epoll_srv.c" 3 4
    2
# 48 "my_epoll_srv.c"
    ,fd,&ev); if(-1==ret)
# 48 "my_epoll_srv.c" 3
...
# 48 "my_epoll_srv.c"
    0
# 48 "my_epoll_srv.c" 3
    ){ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",48,"%s failure,errno=%d[%s]",
# 48 "my_epoll_srv.c"
    "epoll_ctl"
# 48 "my_epoll_srv.c" 3
    ,
...
# 48 "my_epoll_srv.c"
    0
# 48 "my_epoll_srv.c" 3
    ));;; }else{ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",48,"%s failure,errno=%d[%s]",
# 48 "my_epoll_srv.c"
    "epoll_ctl"
# 48 "my_epoll_srv.c" 3
    ,(*__errno_location ()),strerror((*__errno_location ())));;; } }while(0)
...
# 51 "my_epoll_srv.c" 3
    slog(_INF,log_ctrl_set,out_path_set,"","my_epoll_srv.c",51,
# 51 "my_epoll_srv.c"
    "s<-c:%s",buf
# 51 "my_epoll_srv.c" 3
    );;
# 51 "my_epoll_srv.c"
                      ;
     ({ struct epoll_event ev; ev.events = 
# 52 "my_epoll_srv.c" 3 4
    EPOLLOUT
# 52 "my_epoll_srv.c"
    ; ev.data.fd = fd; int ret=epoll_ctl(epfd,
# 52 "my_epoll_srv.c" 3 4
    3
# 52 "my_epoll_srv.c"
    ,fd,&ev); if(-1==ret)
...
# 52 "my_epoll_srv.c"
    0
# 52 "my_epoll_srv.c" 3
    ){ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",52,"%s failure,errno=%d[%s]",
# 52 "my_epoll_srv.c"
    "epoll_ctl"
# 52 "my_epoll_srv.c" 3
    ,
...
# 52 "my_epoll_srv.c"
    0
# 52 "my_epoll_srv.c" 3
    ));;; }else{ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",52,"%s failure,errno=%d[%s]",
# 52 "my_epoll_srv.c"
    "epoll_ctl"
# 52 "my_epoll_srv.c" 3
    ,(*__errno_location ()),strerror((*__errno_location ())));;; } }while(0)
...
# 56 "my_epoll_srv.c"
            strlen(buf)
# 56 "my_epoll_srv.c" 3
            ); if(-1==ret_size){ do { if(0){ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",56,"%s failure,errno=%d[%s]","write",0,strerror(0));;; }else{ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",56,"%s failure,errno=%d[%s]","write",(*__errno_location ()),strerror((*__errno_location ())));;; } }while(0); } ret_size;})
# 56 "my_epoll_srv.c"
                                        ;
    if(n>0){
     ({ struct epoll_event ev; ev.events = 
# 58 "my_epoll_srv.c" 3 4
    EPOLLIN
# 58 "my_epoll_srv.c"
    ; ev.data.fd = fd; int ret=epoll_ctl(epfd,
# 58 "my_epoll_srv.c" 3 4
...
# 58 "my_epoll_srv.c"
    0
# 58 "my_epoll_srv.c" 3
    ){ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",58,"%s failure,errno=%d[%s]",
# 58 "my_epoll_srv.c"
    "epoll_ctl"
# 58 "my_epoll_srv.c" 3
    ,
...
# 58 "my_epoll_srv.c"
    0
# 58 "my_epoll_srv.c" 3
    ));;; }else{ slog(_ERR,log_ctrl_set,out_path_set,"","my_epoll_srv.c",58,"%s failure,errno=%d[%s]",
# 58 "my_epoll_srv.c"
    "epoll_ctl"
# 58 "my_epoll_srv.c" 3
    ,(*__errno_location ()),strerror((*__errno_location ())));;; } }while(0)
